...
const CARD_ARRAY = [
    ...
    {
      name: 'cheeseburger',
      img: '/nftImg/food/cheeseburger.png'
    },
    {
      name: 'ice-cream',
      img: '/nftImg/food/ice-cream.png'
    },
    {
      name: 'pizza',
      img: '/nftImg/food/pizza.png'
    },
    {
      name: 'milkshake',
      img: '/nftImg/food/milkshake.png'
    },
    {
      name: 'hotdog',
      img: '/nftImg/food/hotdog.png'
    },
    {
      name: 'fries',
      img: '/nftImg/food/r.gif'
...
//Choose Image
 chooseImage = (cardId) =>{
          ...
          if(this.state.cardsWon.includes(cardId)){
            return window.location.origin + '/nftImg/food/white.png'
          }else if(this.state.cardsChoosenId.includes(cardId)){
              return CARD_ARRAY[cardId].img
          }else{   
            return window.location.origin + '/nftImg/food/blank.png'
          }
  }
